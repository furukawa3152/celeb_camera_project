...
def sorakoko_judge(test_img):
    ...
    celeb_model = "celeb_face_model.h5"
    model = load_model(celeb_model)
    ...
    label = ['Tom_Cruise_faces', 'Brad_Pitt_faces', 'Keanu_Reeves_faces', 'Justin_Bieber_faces',
              'Natalie_Portman_faces', 'Miranda_Kerr_faces', 'Ariana_Grande_faces',
             'Taylor_Swift_faces', 'Johnny_Depp_faces', 'Emma_Watson_faces']
